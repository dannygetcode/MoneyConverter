...
public class grafica_euro_vs_pesoColombiano extends javax.swing.JFrame {

    
    public grafica_euro_vs_pesoColombiano() {
        initComponents();
        ...
        SetImageLabel(jLabel_grafica_dolar_vs_pesoColombiano, "src/images/grafica_euro_vs_pesoColombiano.jpg");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Comportamiento del Euro frente al  Peso Colombiano");
        getContentPane().add(jLabel1, new org.netbeans.lib.awtextra.AbsoluteConstraints(40, 70, 620, -1));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(grafica_euro_vs_pesoColombiano.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new grafica_euro_vs_pesoColombiano().setVisible(true);
            }
        });
    }
