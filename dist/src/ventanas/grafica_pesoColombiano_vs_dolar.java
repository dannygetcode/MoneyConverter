...
public class grafica_pesoColombiano_vs_dolar extends javax.swing.JFrame {

    /**
     * Creates new form grafica_pesoColombiano_vs_dolar
     */
    public grafica_pesoColombiano_vs_dolar() {
        initComponents();
        ...
        SetImageLabel(jLabel_grafica_dolar_vs_pesoColombiano, "src/images/grafica_pesoC_vs_dolar.jpg");
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Comportamiento del Peso Colombiano frente al Dolar ");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            File sourceFile = new File("src/recursos/COP_USD Historical Data.xlsx");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(grafica_pesoColombiano_vs_dolar.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new grafica_pesoColombiano_vs_dolar().setVisible(true);
            }
        });
    }
